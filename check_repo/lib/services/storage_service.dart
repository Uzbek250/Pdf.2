...
class StorageService {
  ...
  static const _keyThemeStyle = 'app_theme_style';
  ...
  // ---------------------------------------------------------------- //
  // Tanlangan dizayn uslubi (theme: professional / minimalist / vibrant)
  // ---------------------------------------------------------------- //

  Future<void> saveThemeStyle(String styleCode) async {
    await _instance.setString(_keyThemeStyle, styleCode);
  }

  String? getThemeStyle() {
    return _instance.getString(_keyThemeStyle);
  }
